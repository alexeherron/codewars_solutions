...
function weRateDogs(str, rating){
    let twoHalves = str.split('/');
    return twoHalves[0].substring(0, (twoHalves[0].length-2)) + ' ' + rating + '/' + twoHalves[1];
}

//OTHER CLEVER SOLUTION
const weRateDogs = (str, realRating) => {
    return str.replace(/\d+\/\d+/, realRating + '/10')
  }