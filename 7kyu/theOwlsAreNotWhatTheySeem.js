...
//MY SOLUTION
function owls(plumage){
    let left = plumage.toUpperCase().split('').filter(x => ['8','W','T','Y','U','I','O','A','H','X','V','M'].includes(x)).join('');
...
function owlPic(text){
    var wing = text.toUpperCase().replace(/[^8WTYUIOAHXVM]/g,'').split('');
